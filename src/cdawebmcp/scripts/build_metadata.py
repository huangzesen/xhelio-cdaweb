...
def _fetch_from_data_cdf(dataset_id: str, start_date: str, stop_date: str) -> dict | None:
    ...
    """
    from cdawebmcp.metadata import _extract_metadata
    ...
    try:
        from cdawebmcp.fetch import _get_cdf_file_list
    ...
    from cdawebmcp.http import request_with_retry, DOWNLOAD_TIMEOUT
    try:
